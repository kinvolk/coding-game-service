...
// in this file is intended to be used by a wrapper calss to handle method
...
// wrapper class to handle events that occurr on the service. 
const DBUSService = new Lang.Class({
    ...
    completeTaskWithPoints: function(points) {
