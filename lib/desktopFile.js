...
//
// Helper methods to edit desktop files.
...
const EditAction = new Lang.Class({
    ...
    _toObject: function() {
        ...
        this.PARAMS.forEach(key => {
            if (key[0] !== '_') serializable[key] = this['_' + key];
        });
        return serializable;
    },
...
const Editor = new Lang.Class({
    ...
    _init: function(identifier) {
        ...
        let [_, fullPath] = this._keyFile.load_from_data_dirs(path,
